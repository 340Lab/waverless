...
def main(args):
    ...
    logging.info("WasmEdge install start")
    ...
    if compat:
        ...
        # copy to temp path
        # copyfile(join("wasm_edge_uninstall.sh"), uninstaller_path)
        ...
        logging.info("Downloading WasmEdge %s", CONST_release_pkg)
...
if __name__ == "__main__":
    ...
    args.uninstall_script_tag=args.version
